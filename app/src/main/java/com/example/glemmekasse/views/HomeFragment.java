...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        create_button=view.findViewById(R.id.create_post);

        mRecyclerView=view.findViewById(R.id.posts);
        mDataList= PostsData.postsModelClassList;

        mRecyclerView.addItemDecoration(new DividerItemDecoration(mRecyclerView.getContext(), DividerItemDecoration.VERTICAL));
        LinearLayoutManager manager=new LinearLayoutManager(view.getContext());
        mRecyclerView.setLayoutManager(manager);

        PostsAdapter adapter=new PostsAdapter(mDataList,view.getContext());
        mRecyclerView.setAdapter(adapter);

        create_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent create_post=new Intent(getContext(), CreatePosts.class);
